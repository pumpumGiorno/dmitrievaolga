  ...
  return (
    <article className={`property-card group relative flex flex-col self-start ${featured ? 'lg:col-span-2 lg:row-span-2' : ''}`}>
      <Link
        ...
        aria-label={`Подробнее: ${listing.title}, ${listing.location}`}
        className="absolute inset-0 z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold"
      />
      <div className={`pointer-events-none relative overflow-hidden bg-secondary ${featured ? 'aspect-[4/3] lg:aspect-auto lg:min-h-[620px]' : 'aspect-[4/5]'}`}>
